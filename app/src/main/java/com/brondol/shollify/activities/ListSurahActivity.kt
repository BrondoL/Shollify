...
import com.brondol.shollify.fragment.FragmentJadwalSholat.Companion.newInstance
import com.brondol.shollify.adapter.SurahAdapter
import com.brondol.shollify.adapter.SurahAdapter.onSelectData
import com.brondol.shollify.model.ModelSurah
import com.brondol.shollify.networking.Api
import com.brondol.shollify.utils.GetAddressIntentService
...
class ListSurahActivity : AppCompatActivity(), onSelectData {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        llQibla.setOnClickListener(View.OnClickListener {
            startActivity(Intent(this@ListSurahActivity, QiblaActivity::class.java)) })
